...
function Section2() {
    ...
    return (
        <div className="bg-[black]">
            <div className="section2Container w-[1400px] m-auto sm:p-5 pt-[100px]   ">
                        ...
                        <div className="sec2Component   mb-[80px]">
                            <div className="secondName secondContent  w-[600px]  mt-[10px]  ">
                                ...
                                <h6 className="text-justify">
                                    ...
                                    web2 who have built a ton of opensource
                                    projects and crypto products like Gogocoin,
                                    0xPhantomDao, Swix Dao, Bankless Dao,
                                    Mushrohms NFT and{" "}
                                    <a
                                    ...
                                    . We take you from react, redux, nextJS,
                                    ERC720 contract, ERC721 all the way to
                                    advanced gas optimisations and tricks/tips
                                    to create efficient code. Mastering from
                                    Web2 to Web3.
                                </h6>
                            </div>
                            <div className="secondImage">
